	...
	\section{Overall description}
		...
		\subsection{Assumptions, dependencies and constraints}	\label{assumptions}
			...
			\begin{itemize}
				...
				\assumption{11} If an authority confirms a violation report, then the authority generates a traffic ticket from it. So, from the point of view of SafeStreets, every confirmed violation report equals to a traffic ticket.
