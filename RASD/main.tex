	...
	\section{Specific requirements}
		...
		\subsection{Functional Requirements}
			...
			\subsubsection{Use Case Description}
				...
				\textbf{Event flow}:
				\begin{enumerate}
					\item The app shows in a new screen the map, centred in user's position. Then, report violations are represented in the map with pins. Browse the map.
					\item Taps on one of the reports.
					\item Explore data about that report.
				\end{enumerate}
				\textbf{Exit conditions}:
				\begin{itemize}
					\item The user can always leave the "Search" function clicking on the "Exit" button. In this way, he returns to the main page of the app.
				\end{itemize}
				\textbf{Exceptions}: -\\
				...
				\begin{enumerate}
					...
					\item Tap on one of the reports.
					\item Explore data about that report, in particular type of license plate, proof picture, type of violation, date and position.
				\end{enumerate}
				\textbf{Exit conditions}:
				\begin{itemize}
					\item The authority can always leave the "Search" function clicking on the "Exit" button. In this way, it returns to the main page of the app.
				\end{itemize}
				\textbf{Exceptions}: -\\
