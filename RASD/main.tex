		...
		\subsection{Functional Requirements}
			...
			\subsubsection{Use Case Description}
					...
					\begin{itemize}
						...
						\item If the user clicks on "Send" without having filled all the requested fields, the app shows a warning message that tells the user what is wrong. The user can close the warning message and go back to complete the violation report. 
