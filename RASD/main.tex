...
\begin{document}
	...
	\section{Specific requirements}
		\subsection{External Interfaces Requirements}
			...
			\subsubsection{Hardware Interfaces}
				Since SafeStreets is a crowd-sourced application, each user could take advantage of the system only if it have a smartphone. In particular, the smartphone must have camera and GPS.
			\subsubsection{Software Interfaces}
				In order to provide information about traffic violations to users, SafeStreet uses \textbf{external (?)maps} to show where reports come from.\\
		...
		\subsection{Functional Requirements}
			...
			\subsubsection{Use Case Description}
				...
				\textbf{ID}: \usecase{2a} \\
				\textbf{Name}:   Data Mining\\
				\textbf{Actor}:  User\\
				\textbf{Entry conditions}:
				\begin{enumerate}
					\item The app shows in a new screen the map, centred in user's position. Then, report violations are represented in the map with pins.\\
					The user browse the map.
					\item Taps on one of the reports.
					\item Explores data about that report.
				\end{enumerate}
				\textbf{Exit conditions}:
				\begin{itemize}
					\item The user can always leave the "Search" function clicking on the "Back" button. In this way, he returns to the main page of the app.
				\end{itemize}
				\textbf{Exceptions}: -\\
				...
				\textbf{Entry conditions}:
				\begin{enumerate}
					\item Open the SafeStreets AE.
					\item Open the "Search" section.
				\end{enumerate}
				\textbf{Event flow}:
				\begin{enumerate}
					\item The app shows in a new screen the map, centred in authority station position. Then, report violations are represented in the map with pins with different colours, based on confirmed or unconfirmed reports\\
					The authority browse the map.
					\item Taps on one of the reports.
					\item Explores data about that report, in particular type of license plate, proof picture, type of violation, date and position.
				\end{enumerate}
				\textbf{Exit conditions}:
				\begin{itemize}
					\item The authority can always leave the "Search" function clicking on the "Back" button. In this way, he returns to the main page of the app.
				\end{itemize}
				...
				\textbf{ID}: \usecase{33} \\
				\textbf{Name}:   Browse statistics\\
				\textbf{Actor}:  User, Authority\\
				\textbf{Entry conditions}:
				\begin{enumerate}
					\item User opens the SafeStreets application; authority opens SafeStreets AE.
					\item Open the "Statistics" section.
				\end{enumerate}
				\textbf{Event flow}:
				\begin{enumerate}
					\item The app shows in a new screen a list of filter through which either an user or an authority can refine its research.
					They select the filters they want.
					\item Taps on "Show" button.
					\item Explores data about result reports. In particular:
					\begin{itemize}
						\item User can retrieve information about type of violation, date, position and eventually the label "confirmed" or "pending".
						\item Authority can retrieve same information as before, adding license plate and proof picture.
					\end{itemize}
				\end{enumerate}
				\textbf{Exit conditions}:
				\begin{itemize}
					\item Either user or authority can always leave the "Statistics" function clicking on the "Back" button. In this way, he returns to the main page of the app.
				\end{itemize}
				...
				\begin{itemize}
					...
					\item Click "Send" to complete the accident compilation form. The SafeStreets AE returns to the main page.
				\end{itemize}
				\textbf{Exceptions}:
				\begin{itemize}
					\item Some of the requested form are not correctly compiled or empty. In this case a warning message is shown.
				\end{itemize}
			...
			\rule{\linewidth}{0.4pt}
				\textbf{ID}: \usecase{5} \\
			\textbf{Name}: Report confirmation\\
			\textbf{Actor}: Authority\\
			\textbf{Entry conditions}:
			\begin{enumerate}
			...
			\textbf{Exit conditions}:
			\begin{itemize}
				\item Click on the chosen button. If there is another violation report to evaluate, the event flow restarts. Otherwise, the application returns to the main page.
				Remember that SafeStreets considers every confirmed violation report as a given traffic ticket.
	...
	\begin{enumerate}
		\item SafeStreets receives a violation report from a user.
		\item SafeStreets start the "autority search: it checks if there is a registered authority that handles violation reports from the postal code of the current violation report. More precisely:
		\begin{enumerate}
			\item SafeStreets checks if there is a municipality that covers the given postal code. If there is, SafeStreets sends the violation report to that authority and ends the authority search.
			\item If a municipality isn't found, SafeStreets checks if there is a provincial authority that covers the given postal code. If there is, SafeStreets sends the violation report to that authority and ends the authority search.
			\item If a provincial authority isn't found, SafeStreets checks if there is a statal authority that covers the given postal code. If there is, SafeStreets sends the violation report to that authority and ends the authority search.
			\item If no registered authorities satisfy the conditions above, the violation report is discarded.
		\end{enumerate}
	\end{enumerate}
