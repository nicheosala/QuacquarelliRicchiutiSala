	...
	\section{Specific requirements}
		...
		\subsection{Functional Requirements}
			...
			\subsubsection{Use Case Description}
				...
				\textbf{Event flow}:
				\begin{enumerate}
					\item The app provides a side menu through which either an user or an authority can refine its research with data filters.
				...
				\textbf{Exit conditions}:
				\begin{itemize}
					\item Either user or authority can always leave the "Search" function clicking on the "Back" button. In this way, he returns to the main page of the app.
				\end{itemize}
