	...
	\section{Overall description}
		...
		\subsection{Assumptions, dependencies and constraints}	\label{assumptions}
			...
			\begin{itemize}
				...
				\assumption{11} In an authority confirms a violation report, than the authority generates a traffic tickets from it. So, from the point of view of SafeStreets, every confirmed violation report equals to a traffic ticket.
