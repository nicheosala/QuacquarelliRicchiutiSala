...
\begin{document}
	...
	\section{Implementation, integration and test plan}
		...
		\subsection{Integration and testing}
			...
			Thanks to the MVC pattern, the view and the controller of each functionality can be implemented in parallel. In fact, as soon as the interfaces between the view and the controller have been defined, this components interact only using such interfaces.\\
			When the view and the controller of the same functionality have been implemented, a test of the entire system that manage that functionality must be done.\\
